...
const handleSubmit = async (e: Event) => {
  ...
  <form
    ...
    class="w-full md:w-1/2 font-secondary  min-h-full bg-light-card shadow-default-card p-4 rounded-xl space-y-6 2xl:space-y-8"
  >
    <h1 class="font-primary text-3xl 2xl:text-4xl font-bold text-center text-cls-foreground w-full">
      Let's talk!
    </h1>
    <ContactInput
      name="name"
    ...
    <Button.Root variant="pink" className="w-1/2 md:w-1/5 h-10 2xl:h-10 2xl:text-l">
      <Button.Normal label="Submit" type="submit" isLoading={isLoading} disabled={isLoading}/>
    </Button.Root>
